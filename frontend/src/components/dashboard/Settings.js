...
import CutButton from '../../CommonFolder/CutButton'
...
//   }
  ...
  const handlePassword = (e) => {
    ...
    if (newPassword === confirmPassword) {
      updatePassword(user.token,password,navigate);
    } else {
  ...
  return (
    <div className='mt-8'>
      <div className=' flex-1 overflow-auto'>
        <div className='mx-auto h-screen w-11/12 max-w-[1000px] py-10'>
        <h1 className="mb-14 text-3xl font-medium text-black">Edit Profile</h1>
          ...
          <div className="flex justify-end gap-2"><button className="flex items-center bg-yellow-50 cursor-pointer gap-x-2 rounded-md py-2 px-5 font-semibold text-richblack-900 undefined" type="submit">Save</button></div>
             ...
             <form onSubmit={handlePassword}>
              <div  className='relative'>
                                <CutButton link={'/'} css={'absolute z-0 right-4 -translate-y-5'} />
