...
import IconBtn from "../../ReusableComponents/IconBtn";
...
const MyProfile = () => {
  ...
  return (
    <div className="mx-auto w-11/12 h-screen pb-4 max-w-[1000px] py-10">
      <div className="py-10">
        <h1 className="mb-14 text-3xl font-medium text-black text-opacity-75">My Profile</h1>

        {/* section 1 */}
        <div className="flex items-center justify-between rounded-md border-[1px] border-gray-50 bg-gray-50 shadow-md p-3 md:p-8 md:px-12">
